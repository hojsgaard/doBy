...
#' 
#' @description A data frame is split according to some variables in a formula,
#'     and a sample of a certain fraction of each is drawn.
#'
#' @name by-sample
#' 
#' @details If systematic=FALSE (default) then frac gives the fraction of data
...
#'
#' @note This function should perhaps be deprecated.
#' 
#' @return A data frame
