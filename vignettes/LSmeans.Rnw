...
@
<<>>=
K1 <- linest_matrix(rr, effect="Diet", at=list(Time=1)); K1
@ %def
...
@
<<>>=
K0 <- linest_matrix(rr, effect="Diet", at=list(Time=0))
K1-K0
LSmeans(rr, K=K1-K0)
@ %def
...
@
<<>>=
K <- linest_matrix(mod.nst, effect="BB", at=list(CC=2));K
LSmeans(mod.nst, K=K)
@ %def
